...
$envVars = "^|^GCP_PROJECT_ID=$PROJECT_ID|GCP_REGION=$REGION|RAG_CORPUS_NAME=$($env:RAG_CORPUS_NAME)|GCS_RAW_BUCKET=$GCS_RAW|GCS_NORMALIZED_BUCKET=$GCS_NORM|MCP_API_KEY=$MCP_API_KEY|TOP_K_DEFAULT=$TOP_K"
