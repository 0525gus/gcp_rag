...
$RAW_UPLOAD = Get-EnvOr RAW_UPLOAD_CONCURRENCY "8"
...
$GCS_RAW = $env:GCS_RAW_BUCKET
$GCS_NORM = $env:GCS_NORMALIZED_BUCKET
...
$parserEnv = "^|^GCP_PROJECT_ID=$PROJECT_ID|GCP_REGION=$REGION|GCS_RAW_BUCKET=$GCS_RAW|GCS_NORMALIZED_BUCKET=$GCS_NORM|RAG_CORPUS_NAME=$CORPUS|DOCAI_PROCESSOR_ID=$DOCAI|QG_MODE=$QG_MODE|FIRESTORE_DATABASE=$FS_DB|FIRESTORE_COLLECTION=$FS_COL"
...
$syncEnv = "^|^GCP_PROJECT_ID=$PROJECT_ID|GCP_REGION=$REGION|GCS_RAW_BUCKET=$GCS_RAW|GCS_NORMALIZED_BUCKET=$GCS_NORM|RAG_CORPUS_NAME=$CORPUS|DRIVE_IDS=$DRIVE_IDS|SYNC_FOLDER_IDS=$SYNC_FOLDERS|FIRESTORE_COLLECTION=$FS_COL|FIRESTORE_DATABASE=$FS_DB|QG_MODE=$QG_MODE|RAW_UPLOAD_CONCURRENCY=$RAW_UPLOAD|RAG_DELETE_PACING_SECONDS=$RAG_DEL_PACE|RAG_DELETE_CONCURRENCY=$RAG_DEL_CONC|RAG_CORPUS_NAME_STUDENT=$STUDENT_CORPUS|STUDENT_FOLDER_IDS=$STUDENT_FOLDERS"
...
$mcpEnv = "^|^GCP_PROJECT_ID=$PROJECT_ID|GCP_REGION=$REGION|RAG_CORPUS_NAME=$CORPUS|GCS_RAW_BUCKET=$GCS_RAW|GCS_NORMALIZED_BUCKET=$GCS_NORM|FIRESTORE_DATABASE=$FS_DB|FIRESTORE_COLLECTION=$FS_COL|MCP_API_KEY=$MCP_API_KEY|TOP_K_DEFAULT=$TOP_K|SEARCH_FETCH_MULTIPLIER=$FETCH_MULT|SEARCH_FETCH_MAX=$FETCH_MAX"
