...
$ConfigKeys = @(
  ...
  "SEARCH_MAX_TOTAL_CHUNKS", "SEARCH_MAX_CHUNKS_PER_FILE",
  "SEARCH_LEXICAL_RERANK", "SEARCH_REWRITE_ENABLED", "SEARCH_REWRITE_MODEL",
  "SEARCH_REWRITE_TIMEOUT_SECONDS", "SEARCH_REWRITE_WEIGHT",
  "SEARCH_TITLE_RERANK_WEIGHT",
  "SEARCH_TEMPORAL_RANK_WEIGHT",
  "SEARCH_SEQUENCE_RANK_WEIGHT", "SEARCH_DOCUMENT_KIND_RANK_WEIGHT",
  "SEARCH_REVISION_RANK_WEIGHT",
  "SEARCH_RERANKER_MODE", "SEARCH_RERANKER_CANDIDATE_K",
  "SEARCH_CROSS_ENCODER_MODEL", "SEARCH_LLM_RERANKER_MODEL",
  "SEARCH_RERANKER_TIMEOUT_SECONDS",
  "MCP_CONCURRENCY", "ALLOW_UNAUTH", "MCP_UNIFIED_ENABLED", "MCP_CPU",
